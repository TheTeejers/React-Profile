      ...
      <div className="App">
        ...
        <div className="projectsContainer">
          ...
          <div className="projectDisplayContainer">
            ...
            <div className="project4Front front"><img className='hackathonImage' src={hackathon_resources_screenshot}/></div>
          </div>
          ...
          <div className="projectDisplayContainer">
            ...
            <div className="project1Front front"><img className='ufhomeImage' src={ufhome_screenshot4}/></div>
          </div>
          ...
          <div className="projectDisplayContainer">
            <div className="project2Back back appInfo">
              <p className="projectParagraph">
                Pupfetcher was the first group project we did at General Assembly.  Our group was comprised of a total of four students.  We were expected to follow these requirements:
                  <ul>
                    <li className="projectList">Build an Express Application that has JSON endpoints.</li>
                    <li className="projectList">Design our CRUD routes using the REST convention.</li>
                    <li className="projectList">Leverage AJAX to fetch JSON data from the backend.</li>
                    <li className="projectList">Use jQuery to add interactivity and render data on the client-side.</li>
                    <li className="projectList">Render the JSON data on the frontend using ES6 String literals or on the backend using EJS.</li>
                    <li className="projectList">Persist at least two models to a Mongo Database. Use at least one one-to-many or many-to-many relationship between models. You can choose to reference or embed your data.</li>
                    <li className="projectList">Git 50+ commits. Commit early, commit often. </li>
                    <li className="projectList">You must use semantically clean HTML and CSS.</li>
                    <li className="projectList">Deploy our app to Heroku.</li>
                  </ul>
              </p>
              <p className="projectParagraph">
            ...
            <div className="project2Front front"><img className='pupfetcherImage' src={pupfetcher_screenshot2}/></div>
          </div>
          ...
          <div className="projectDisplayContainer">
            ...
            <div className="project3Front front"><img className='fooddiceImage' src={fooddice_screenshot}/></div>
          </div>
          ...
          <div className="projectDisplayContainer bottomProject">
            <div className="project4Back back appInfo">
              <p className="projectParagraph">
                ...
                <ul className="projectUL">
                  ...
                  <li className="projectList">Users should be able to click on any empty box to make a move.</li>
                  <li className="projectList">Every move should alternate between marking an X and O (the two players).</li>
                  <li className="projectList">A user should not be able to claim a box that has already been claimed for X or O.</li>
                  <li className="projectList">Users should be able to click a "reset" button to clear all X's and O's from the board and restart the game.</li>
                </ul>
                <ul className="projectUL">
                  Further Challenge Ideas
                  <li className="projectList">Display a message to indicate which player's turn is about to be played (X or O).</li>
                  <li className="projectList">If a player wins, show a message with the mark of the winner. Separate your code that finds the winner (if there is a winner) into its own function.</li>
                  <li className="projectList">If the board fills up before anyone wins, show a message declaring the game a draw.</li>
                  <li className="projectList">Display separate colors for X's and O's.</li>
                  <li className="projectList">Creatively style your tic-tac-toe game!</li>
                  <li className="projectList">Research "event delegation," and attach your event listeners to the whole board instead of individual boxes.</li>
                </ul>
            ...
            <div className="project4Front front"><img className='tictactoeImage' src={tictactoe_screenshot}/></div>
          </div>
